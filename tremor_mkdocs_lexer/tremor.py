...
class TremorLexer(RegexLexer):
    ...
    tokens = {
      'root': [
            ...
            (r'#(.*?)\n', Comment.Single),
            # keywords
            (r'(use|const|let|emit|drop|match|of|case|when|default|end|patch|insert|update|upsert|erase|merge|for|present|absent|fn|as|with|mod|intrinsic|recur)\b', Keyword.Declaration),
            (words((
